...
import { ProductionQuantityLimits, SecurityOutlined } from '@mui/icons-material'
...
import { TbBrandApple, TbCategoryMinus } from 'react-icons/tb'
...
const navConfig = [
    ...
    },
    {
        ...
        path: '/admin/product',
        icon: <ProductionQuantityLimits fontSize='20px' />
    },
    {
    ...
    },
    {
        title: 'Bảo hành',
        path: '/admin/warranty',
        icon: <SecurityOutlined fontSize='30px' />
    }
]
